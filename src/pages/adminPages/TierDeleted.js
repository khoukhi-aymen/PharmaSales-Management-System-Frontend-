...
class ClientsActifs extends Component {
    ...
    componentDidMount() {
        axios
            .get("http://localhost:8000/biztrack/get/Tier/deleted", { withCredentials: true })
            .then((res) => {
    ...
    fetchClientsByDate = () => {
        ...
        if (dateDebut && dateFin) {
            axios
                .get(`http://localhost:8000/biztrack/get/Tier/deleted/FiltrerParDate`, {
    ...
    render() {
        ...
        return (
            <section className="appointments-section deleted-page">
                <div
                ...
                >
                    <h2 className="title">Liste des clients / Fournisseurs supprimés</h2>
